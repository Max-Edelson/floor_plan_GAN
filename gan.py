...
G_HIDDEN = 64 # Size of feature maps in the generator that are propagated through the generator.
X_DIM = 64 # An original image size in MNIST is 28x28. I will change 28x28 to 64x64 with a resize module for the network.
D_HIDDEN = 64 # Size of feature maps in the discriminator.
